import type { SidecarSandboxPosture } from './types.js';
...
/** Layer-1 confinement was requested and no backend could wrap the process. */
export class SidecarSandboxUnavailableError extends SidecarBootError {
  constructor(
    message: string,
    public readonly posture: SidecarSandboxPosture,
    cause?: unknown,
  ) {
    super(message, cause);
    this.name = 'SidecarSandboxUnavailableError';
  }
}
