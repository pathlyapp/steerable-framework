...
_SYSTEM = (
    ...
    "query-word hit instead of the library's own title. A -zh- model "
    "still needs those prefixes on an English query. If the instruction "
    "asks for the Nth highest cosine, write that rank, not the first "
    "hit, and not a coding-benchmark title (HumanEval, MBPP). "
