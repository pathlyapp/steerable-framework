...
_SYSTEM = (
    ...
    "preview for 8-bit PNG and uncompressed BMP (square images also get a "
    "rank/file 8x8 brightness grid); decode JPEG and exact pixels with "
    "Python (PIL/numpy) or ffmpeg. "
