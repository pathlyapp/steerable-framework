...
where we lag. Steerable is an early-stage project (`0.6.x`); this page is
...
2. **The loop yields structured events, not bytes.** The `LoopEvent`
   taxonomy (15 kinds) was derived from a production
